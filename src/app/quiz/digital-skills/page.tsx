  ...
  return (
    <>
      ...
      <section className="h-full lg:h-screen flex flex-col items-center justify-center p-2 sm:py-[1rem] sm:px-[3rem] font-text">
        <div className="main-container  h-full w-full flex items-center justify-center overflow-y-auto ">
          {!started && !finished && (
            <>
              <div className="flex flex-col justify-between max-h-[50rem] h-full max-w-4xl m-auto size-full">
                ...
                <Link href={"/dashboard"} className="danger-button flex gap-2">
                  <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  ><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 11l-4 4l4 4m-4 -4h11a4 4 0 0 0 0 -8h-1" /></svg>
                  Kembali
                </Link>
                  ...
                  <div className=" p-1 sm:p-5 ">
                    <div className="main-button relative !text-[2rem] mb-5">
                      ...
                      <Image
                        ...
                        width={500}
                        height={500}
                        className="absolute -top-8 -left-3 w-[3rem]"
                      />
                    </div>
